...
define("dijit/InlineEditBox", "require dojo/_base/array dojo/aspect dojo/_base/declare dojo/dom-attr dojo/dom-class dojo/dom-construct dojo/dom-style dojo/i18n dojo/_base/kernel dojo/keys dojo/_base/lang dojo/on dojo/sniff dojo/when ./a11yclick ./focus ./_Widget ./_TemplatedMixin ./_WidgetsInTemplateMixin ./_Container ./form/Button ./form/_TextBoxMixin ./form/TextBox dojo/text!./templates/InlineEditBox.html dojo/i18n!./nls/common".split(" "), function(t, l, u, m, n, e, v, g, x, p, w, c, f, q, y, 
z, r, b, h, A, E, F, B, C, D) {
  h = m("dijit._InlineEditor", [b, h, A], {templateString:D, contextRequire:t, postMixInProperties:function() {
    ...
    this.inherited(arguments);
    var a = "string" == typeof this.editor ? c.getObject(this.editor) || t(this.editor) : this.editor, d = this.sourceStyle, k = "line-height:" + d.lineHeight + ";", e = g.getComputedStyle(this.domNode);
    ...
    b = c.delegate(this.inlineEditBox.editorParams, {style:k, dir:this.dir, lang:this.lang, textDir:this.textDir});
    ...
    this.inlineEditBox.autoSave ? this.own(u.after(a, "onChange", c.hitch(this, "_onChange"), !0), f(a, "keydown", c.hitch(this, "_onKeyDown"))) : "intermediateChanges" in a && (a.set("intermediateChanges", !0), this.own(u.after(a, "onChange", c.hitch(this, "_onIntermediateChange"), !0)), this.saveButton.set("disabled", !0));
  }, startup:function() {
    ...
    this.inlineEditBox.autoSave && this.inlineEditBox.editing && !a.altKey && !a.ctrlKey && (a.keyCode == w.ESCAPE ? (a.stopPropagation(), a.preventDefault(), this.cancel(!0)) : a.keyCode == w.ENTER && "INPUT" == a.target.tagName && (a.stopPropagation(), a.preventDefault(), this._onChange()));
  }, _onBlur:function() {
    this.inherited(arguments);
  ...
  b = m("dijit.InlineEditBox" + (q("dojo-bidi") ? "_NoBidi" : ""), b, {editing:!1, autoSave:!0, buttonSave:"", buttonCancel:"", renderAsHtml:!1, editor:C, editorWrapper:h, editorParams:{}, disabled:!1, onChange:function() {
  }, onCancel:function() {
    ...
    if (!this.disabled && !this.editing) {
      ...
      g.set(d.domNode, {visibility:"visible"});
      n.set(this.displayNode, "tabIndex", "-1");
      var b = d.editWidget, f = this;
    ...
    g.set(b.domNode, {visibility:"hidden"});
