...
function(D, k, r, t, u, E, v, p, l, z, F, A, e, B, G, m, q, H, I, f, g, P, J, K, L, M, w, N, x, O) {
  ...
  var y = new u;
  y.resolve(!0);
  g = t("dijit._DialogBase" + (m("dojo-bidi") ? "_NoBidi" : ""), [J, L, M, K], {templateString:O, baseClass:"dijitDialog", cssStateNodes:{closeButtonNode:"dijitDialogCloseIcon"}, _setTitleAttr:{node:"titleNode", type:"innerHTML"}, open:!1, duration:g.defaultDuration, refocus:!0, autofocus:!0, _firstFocusItem:null, _lastFocusItem:null, draggable:!0, _setDraggableAttr:function(a) {
    this._set("draggable", a);
  }, maxRatio:.9, closable:!0, _setClosableAttr:function(a) {
    ...
    var a = this.domNode;
    this.titleBar && this.draggable ? (this._moveable = new (6 == m("ie") ? I : H)(a, {handle:this.titleBar}), r.after(this._moveable, "onMoveStop", e.hitch(this, "_endDrag"), !0)) : v.add(a, "dijitDialogFixed");
    ...
    if (!v.contains(this.ownerDocumentBody, "dojoMove")) {
      var a = this.domNode, b = q.getBox(this.ownerDocument), c = this._relativePosition, d = p.position(a);
      l.set(a, {left:Math.floor(b.l + (c ? Math.min(c.x, b.w - d.w) : (b.w - d.w) / 2)) + "px", top:Math.floor(b.t + (c ? Math.min(c.y, b.h - d.h) : (b.h - d.h) / 2)) + "px"});
    }
  }, _onKey:function(a) {
    if (a.keyCode == A.TAB) {
      this._getFocusItems();
      ...
      this.closable && a.keyCode == A.ESCAPE && (this.onCancel(), a.stopPropagation(), a.preventDefault());
    }
  }, show:function() {
    if (this.open) {
      return y.promise;
    ...
    this._modalconnects.push(B(this.domNode, "keydown", e.hitch(this, "_onKey")));
    ...
    b = z.fadeIn({node:this.domNode, duration:this.duration, beforeBegin:e.hitch(this, function() {
    ...
    a = z.fadeOut({node:this.domNode, duration:this.duration, onEnd:e.hitch(this, function() {
    ...
    if ("none" != this.domNode.style.display) {
      ...
      if (a) {
        ...
        this._singleChild ? (b = x.marginBox2contentBox(this.containerNode, c), this._singleChild.resize({w:b.w, h:b.h})) : (this.containerNode.style.overflow = "auto", this._layoutChildren());
      } else {
  ...
  m("dojo-bidi") && (g = t("dijit._DialogBase", g, {_setTitleAttr:function(a) {
    this._set("title", a);
  ...
  var h = n._DialogLevelManager = {_beginZIndex:950, show:function(a, b) {
    ...
    if (d[d.length - 1].dialog == a) {
      ...
      if (a.refocus && (a = b.focus, !b.dialog || a && E.isDescendant(a, b.dialog.domNode) || (b.dialog._getFocusItems(), a = b.dialog._firstFocusItem), a)) {
        try {
          a.focus();
        } catch (c) {
        }
  ...
  f.watch("curNode", function(a, b, c) {
    ...
    if (c && a && !a._fadeOutDeferred && c.ownerDocument == a.ownerDocument) {
      do {
        if (c == a.domNode || v.contains(c, "dijitPopup")) {
          return;
        }
