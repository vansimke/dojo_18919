...
define("dijit/form/DropDownButton", "dojo/_base/declare dojo/_base/kernel dojo/_base/lang dojo/query ../registry ../popup ./Button ../_Container ../_HasDropDown dojo/text!./templates/DropDownButton.html ../a11yclick".split(" "), function(e, d, f, p, g, h, k, l, m, n) {
  return e("dijit.form.DropDownButton", [k, l, m], {baseClass:"dijitDropDownButton", templateString:n, _fillContent:function() {
    var a = this.srcNodeRef, c = this.containerNode;
    if (a && c) {
      for (;a.hasChildNodes();) {
        var b = a.firstChild;
        b.hasAttribute && (b.hasAttribute("data-dojo-type") || b.hasAttribute("dojoType") || b.hasAttribute("data-" + d._scopeName + "-type") || b.hasAttribute(d._scopeName + "Type")) ? (this.dropDownContainer = this.ownerDocument.createElement("div"), this.dropDownContainer.appendChild(b)) : c.appendChild(b);
      }
    }
  }, startup:function() {
    ...
    var c = this.dropDown, b = c.on("load", f.hitch(this, function() {
      b.remove();
      a();
    }));
    c.refresh();
