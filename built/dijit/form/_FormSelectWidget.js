//>>built
define("dijit/form/_FormSelectWidget", "dojo/_base/array dojo/_base/Deferred dojo/aspect dojo/data/util/sorter dojo/_base/declare dojo/dom dojo/dom-class dojo/_base/kernel dojo/_base/lang dojo/query dojo/when dojo/store/util/QueryResults ./_FormValueWidget".split(" "), function(d, h, k, m, n, p, q, l, e, r, t, u, v) {
  return n("dijit.form._FormSelectWidget", v, {multiple:!1, options:null, store:null, _setStoreAttr:function(a) {
    ...
    d.forEach(e.isArrayLike(a) ? a : [a], function(a) {
    ...
    a && a.query && (this._loadingStore = !0, this.onLoadDeferred = new h, this._queryRes = a.query(this.query, this.queryOptions), t(this._queryRes, e.hitch(this, function(f) {
    ...
    if (this._loadingStore) {
      ...
      if (null != a) {
        a = e.isArrayLike(a) ? d.map(a, function(a) {
        ...
        this.multiple || a[0] && a[0].value || !b.length || (a[0] = b[0]);
    ...
    var a = this.store;
    a && (a.getIdentity || a.getFeatures()["dojo.data.api.Identity"]) && (this.store = null, this._deprecatedSetStore(a, this._oValue, {query:this.query, queryOptions:this.queryOptions}));
