...
define("dijit/form/_SearchMixin", "dojo/_base/declare dojo/keys dojo/_base/lang dojo/query dojo/string dojo/when ../registry".split(" "), function(m, f, k, q, n, l, p) {
  return m("dijit.form._SearchMixin", null, {pageSize:Infinity, store:null, fetchProperties:{}, query:{}, list:"", _setListAttr:function(a) {
    ...
    this._abortQuery();
    var c = this, h = k.clone(this.query), b = {start:0, count:this.pageSize, queryOptions:{ignoreCase:this.ignoreCase, deep:!0}}, g = n.substitute(this.queryExpr, [a.replace(/([\\\*\?])/g, "\\$1")]), d, f = function() {
      ...
      c.disabled || c.readOnly || d !== c._lastQuery || l(a, function(e) {
        ...
        c.disabled || c.readOnly || d !== c._lastQuery || l(a.total, function(a) {
          ...
          e.nextPage = function(a) {
            ...
            0 >= b.count ? (e.length = 0, c.onSearch(e, h, b)) : f();
          };
          c.onSearch(e, h, b);
        });
      }, function(a) {
