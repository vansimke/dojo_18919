...
define("dijit/Viewport", ["dojo/Evented", "dojo/on", "dojo/domReady", "dojo/sniff", "dojo/window"], function(h, e, k, f, g) {
  ...
  d.getEffectiveBox = function(a) {
    ...
    f("ios") && b && !b.readOnly && ("textarea" == c || "input" == c && /^(color|email|number|password|search|tel|text|url)$/.test(b.type)) && (a.h *= 0 == orientation || 180 == orientation ? .66 : .4, c = b.getBoundingClientRect(), a.h = Math.max(a.h, c.top + c.height));
    return a;
  };
  return d;
});
