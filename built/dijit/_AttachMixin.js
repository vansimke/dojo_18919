//>>built
define("dijit/_AttachMixin", "require dojo/_base/array dojo/_base/connect dojo/_base/declare dojo/_base/lang dojo/mouse dojo/on dojo/touch ./_WidgetBase".split(" "), function(n, d, f, p, g, l, q, r, t) {
  var u = g.delegate(r, {mouseenter:l.enter, mouseleave:l.leave, keypress:f._keypress}), m;
  f = p("dijit._AttachMixin", null, {constructor:function() {
    ...
    if (a = a(b, "dojoAttachEvent") || a(b, "data-dojo-attach-event")) {
      for (c = a.split(/\s*,\s*/), h = g.trim;a = c.shift();) {
        if (a) {
          var e = null;
    ...
    a = "dijitclick" == a ? m || (m = n("./a11yclick")) : u[a] || a;
    return q(b, a, d);
  ...
  g.extend(t, {dojoAttachEvent:"", dojoAttachPoint:""});
  return f;
});
