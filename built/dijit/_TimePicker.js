//>>built
define("dijit/_TimePicker", "dojo/_base/array dojo/date dojo/date/locale dojo/date/stamp dojo/_base/declare dojo/dom-class dojo/dom-construct dojo/_base/kernel dojo/keys dojo/_base/lang dojo/sniff dojo/query dojo/mouse dojo/on ./_WidgetBase ./form/_ListMouseMixin".split(" "), function(r, h, k, g, l, f, m, n, e, t, u, v, w, x, p, q) {
  return l("dijit._TimePicker", [p, q], {baseClass:"dijitTimePicker", pickerMin:"T00:00:00", pickerMax:"T23:59:59", clickableIncrement:"T00:15:00", visibleIncrement:"T01:00:00", value:new Date, _visibleIncrement:2, _clickableIncrement:1, _totalIncrements:10, constraints:{}, serialize:g.toISOString, buildRendering:function() {
    ...
    for (c = 0;c < this._maxIncrement;c++) {
      (b = this._createOption(c)) && a.appendChild(b);
    }
    return a;
  }, _showText:function() {
    var a = g.fromISOString;
    ...
    }, b = c(this._clickableIncrementDate), c = c(this._visibleIncrementDate);
    ...
    !b.firstChild && this.filterString ? (this.filterString = "", this._showText()) : this.domNode.appendChild(b);
    ...
    for (var c in{clickableIncrement:1, visibleIncrement:1, pickerMin:1, pickerMax:1}) {
      c in a && (this[c] = a[c]);
    }
    a.locale || (a.locale = this.lang);
  }, _createOption:function(a) {
    var c = new Date(this._refDate), b = this._clickableIncrementDate;
    ...
    if (this.filterString && 0 !== d.toLowerCase().indexOf(this.filterString)) {
      return null;
    }
    ...
    b.date = c;
    b.idx = a;
    m.create("div", {"class":this.baseClass + "ItemInner", innerHTML:d}, b);
    ...
    this.value && !h.compare(this.value, c, this.constraints.selector) && (b.selected = !0, b.className += " " + this.baseClass + "ItemSelected", this._selectedDiv = b, d ? b.className += " " + this.baseClass + "MarkerSelected" : a && (b.className += " " + this.baseClass + "TickSelected"), this._highlightOption(b, !0));
    return b;
  }, onOpen:function() {
    this.inherited(arguments);
    ...
    if (a) {
      ...
      f.toggle(a, this.baseClass + "ItemHover", c);
      f.contains(a, this.baseClass + "Marker") ? f.toggle(a, this.baseClass + "MarkerHover", c) : f.toggle(a, this.baseClass + "TickHover", c);
    }
  }, handleKey:function(a) {
    if (a.keyCode == e.DOWN_ARROW) {
      return this.selectNextNode(), this._onOptionSelected({target:this._highlighted_option}, !1), a.stopPropagation(), a.preventDefault(), !1;
    }
    if (a.keyCode == e.UP_ARROW) {
      return this.selectPreviousNode(), this._onOptionSelected({target:this._highlighted_option}, !1), a.stopPropagation(), a.preventDefault(), !1;
    }
    if (a.keyCode == e.ENTER || a.keyCode === e.TAB) {
      if (!this._keyboardSelected && a.keyCode === e.TAB) {
        return !0;
      }
      this._highlighted_option && this._onOptionSelected({target:this._highlighted_option}, !0);
    ...
    this._onOptionSelected({target:a}, !0);
  }});
});
