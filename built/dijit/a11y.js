//>>built
define("dijit/a11y", "dojo/_base/array dojo/dom dojo/dom-attr dojo/dom-style dojo/_base/lang dojo/sniff ./main".split(" "), function(x, g, f, h, u, v, w) {
  var e = {_isElementShown:function(a) {
    ...
    var k, l, m, g, n, q, p = {}, r = e._isElementShown, h = e.effectiveTabIndex, t = function(b) {
    ...
    r(a) && t(a);
    return {first:d(k), last:d(l), lowest:d(m), highest:d(n)};
