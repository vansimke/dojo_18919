//>>built
define("dijit/layout/StackContainer", "dojo/_base/array dojo/cookie dojo/_base/declare dojo/dom-class dojo/dom-construct dojo/has dojo/_base/lang dojo/on dojo/ready dojo/topic dojo/when ../registry ../_WidgetBase ./_LayoutWidget".split(" "), function(d, k, e, g, h, n, l, p, q, f, r, m, t, u) {
  n("dijit-legacy-requires") && q(0, function() {
    require(["dijit/layout/StackController"]);
  });
  e = e("dijit.layout.StackContainer", u, {doLayout:!0, persist:!1, baseClass:"dijitStackContainer", buildRendering:function() {
    ...
    var c;
    a = m.byId(a);
    this.selectedChildWidget != a && (c = this._transition(a, this.selectedChildWidget, b), this._set("selectedChildWidget", a), f.publish(this.id + "-selectChild", a, this._focused), this.persist && k(this.id + "_selectedChild", this.selectedChildWidget.id));
    return r(c || !0);
    ...
    if (!a.onClose || a.onClose(this, a)) {
      this.removeChild(a), a.destroyRecursive();
    }
  ...
  l.extend(t, e.ChildWidgetProperties);
  return e;
});
