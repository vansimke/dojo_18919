...
define("dijit/layout/AccordionContainer", "require dojo/_base/array dojo/_base/declare dojo/_base/fx dojo/dom dojo/dom-attr dojo/dom-class dojo/dom-construct dojo/dom-geometry dojo/keys dojo/_base/lang dojo/sniff dojo/topic ../focus ../_base/manager dojo/ready ../_Widget ../_Container ../_TemplatedMixin ../_CssStateMixin ./StackContainer ./ContentPane dojo/text!./templates/AccordionButton.html ../a11yclick".split(" "), function(w, n, f, x, y, p, z, g, h, e, k, m, q, A, B, C, t, G, D, u, E, H, F) {
  function v(a, b) {
    a.resize ? a.resize(b) : h.setMarginBox(a.domNode, b);
  }
  q = f("dijit.layout._AccordionButton", [t, D, u], {templateString:F, label:"", _setLabelAttr:{node:"titleTextNode", type:"innerHTML"}, title:"", _setTitleAttr:{node:"titleTextNode", type:"attribute", attribute:"title"}, iconClassAttr:"", _setIconClassAttr:{node:"iconNode", type:"class"}, baseClass:"dijitAccordionTitle", getParent:function() {
    return this.parent;
    ...
    y.setSelectable(this.domNode, !1);
  }, getTitleHeight:function() {
    return h.getMarginSize(this.domNode).h;
  }, _onTitleClick:function() {
    this.getParent().selectChild(this.contentWidget, !0);
    A.focus(this.focusNode);
  ...
  var r = f("dijit.layout._AccordionInnerContainer" + (m("dojo-bidi") ? "_NoBidi" : ""), [t, u], {baseClass:"dijitAccordionInnerContainer", isLayoutContainer:!0, buildRendering:function() {
    this.domNode = g.place("\x3cdiv class\x3d'" + this.baseClass + "' role\x3d'presentation'\x3e", this.contentWidget.domNode, "after");
    var a = this.contentWidget, b = k.isString(this.buttonWidget) ? k.getObject(this.buttonWidget) : this.buttonWidget;
    ...
    this._contentWidgetWatches = [b.watch("title", k.hitch(this, function(b, d, l) {
      a.set("label", l);
    })), b.watch("tooltip", k.hitch(this, function(b, d, l) {
      a.set("title", l);
    })), b.watch("iconClass", k.hitch(this, function(b, d, l) {
      a.set("iconClass", l);
    }))];
  }, _setSelectedAttr:function(a) {
    this._set("selected", a);
  ...
  m("dojo-bidi") && (r = f("dijit.layout._AccordionInnerContainer", r, {postCreate:function() {
    this.inherited(arguments);
    var a = this.button;
  ...
  f = f("dijit.layout.AccordionContainer", E, {duration:B.defaultDuration, buttonWidget:q, baseClass:"dijitAccordionContainer", buildRendering:function() {
    this.inherited(arguments);
    ...
    if (a) {
      var b = a._wrapperWidget.domNode, c = h.getMarginExtents(b), b = h.getPadBorderExtents(b), d = a._wrapperWidget.containerNode, l = h.getMarginExtents(d), d = h.getPadBorderExtents(d), f = this._contentBox, e = 0;
      n.forEach(this.getChildren(), function(b) {
        b != a && (e += h.getMarginSize(b._wrapperWidget.domNode).h);
      });
      this._verticalSpace = f.h - e - c.h - b.h - l.h - d.h - a._buttonWidget.getTitleHeight();
      this._containerContentBox = {h:this._verticalSpace, w:this._contentBox.w - c.w - b.w - l.w - d.w};
      a && v(a, this._containerContentBox);
    }
    ...
    z.remove(a.domNode, "dijitHidden");
    this.inherited(arguments);
    ...
    if (a) {
      ...
      this.doLayout && v(a, this._containerContentBox);
    }
    ...
    if (c) {
      ...
      a = h.getMarginExtents(c);
      c = h.getPadBorderExtents(c);
      var k = a.h + c.h;
      g.style.height = d._verticalSpace - k + "px";
      this._animation = new x.Animation({node:e, duration:this.duration, curve:[1, this._verticalSpace - k - 1], onAnimate:function(a) {
        a = Math.floor(a);
        e.style.height = a + "px";
        g.style.height = d._verticalSpace - k - a + "px";
      }, onEnd:function() {
        delete d._animation;
        e.style.height = "auto";
    ...
    if (!this.disabled && !a.altKey && (b || a.ctrlKey)) {
      var c = a.keyCode;
      if (b && (c == e.LEFT_ARROW || c == e.UP_ARROW) || a.ctrlKey && c == e.PAGE_UP) {
        this._adjacent(!1)._buttonWidget._onTitleClick(), a.stopPropagation(), a.preventDefault();
      } else {
        if (b && (c == e.RIGHT_ARROW || c == e.DOWN_ARROW) || a.ctrlKey && (c == e.PAGE_DOWN || c == e.TAB)) {
