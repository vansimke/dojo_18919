...
define("dijit/_editor/plugins/FontChoice", "require dojo/_base/array dojo/_base/declare dojo/dom-construct dojo/i18n dojo/_base/lang dojo/store/Memory ../../registry ../../_Widget ../../_TemplatedMixin ../../_WidgetsInTemplateMixin ../../form/FilteringSelect ../_Plugin ../range dojo/i18n!../nls/FontChoice".split(" "), function(g, k, h, t, u, l, v, w, x, y, z, A, m, n) {
  g = h("dijit._editor.plugins._FontDropDown", [x, y, z], {label:"", plainText:!1, templateString:"\x3cspan style\x3d'white-space: nowrap' class\x3d'dijit dijitReset dijitInline'\x3e\x3clabel class\x3d'dijitLeft dijitInline' for\x3d'${selectId}'\x3e${label}\x3c/label\x3e\x3cinput data-dojo-type\x3d'../../form/FilteringSelect' required\x3d'false' data-dojo-props\x3d'labelType:\"html\", labelAttr:\"label\", searchAttr:\"name\"' class\x3d'${comboClass}' tabIndex\x3d'-1' id\x3d'${selectId}' data-dojo-attach-point\x3d'select' value\x3d''/\x3e\x3c/span\x3e", 
  contextRequire:g, postMixInProperties:function() {
    ...
    this.select.set("store", new v({idProperty:"value", data:k.map(this.values, function(b) {
  ...
  var p = h("dijit._editor.plugins._FontNameDropDown", g, {generic:!1, command:"fontName", comboClass:"dijitFontNameCombo", postMixInProperties:function() {
  ...
  }}), q = h("dijit._editor.plugins._FontSizeDropDown", g, {command:"fontSize", comboClass:"dijitFontSizeCombo", values:[1, 2, 3, 4, 5, 6, 7], getLabel:function(b, a) {
  ...
  }}), r = h("dijit._editor.plugins._FormatBlockDropDown", g, {command:"formatBlock", comboClass:"dijitFormatBlockCombo", values:"noFormat p h1 h2 h3 pre".split(" "), postCreate:function() {
    this.inherited(arguments);
        ...
        if (d) {
            ...
            if (a.childNodes && a.childNodes.length) {
              ...
              for (d = 0;d < a.childNodes.length;d++) {
                ...
                if (1 == e.nodeType && b.selection.inSelection(e)) {
                  ...
                  -1 !== k.indexOf(this.values, f) && c.push(e);
                  g(e, c);
                }
              }
            }
          ...
          if (a == c) {
            ...
            for (c = a;b.selection.inSelection(c);) {
              1 == c.nodeType && (e = c.tagName ? c.tagName.toLowerCase() : "", -1 !== k.indexOf(this.values, e) && f.push(c), g(c, f)), c = c.nextSibling;
            }
          }
          d(f);
          b.onDisplayChanged();
  ...
  }}), f = h("dijit._editor.plugins.FontChoice", m, {useDefaultCommand:!1, _initButton:function() {
    var b = {fontName:p, fontSize:q, formatBlock:r}[this.command], a = this.params;
    this.params.custom && (a.values = this.params.custom);
    var d = this.editor;
    this.button = new b(l.delegate({dir:d.dir, lang:d.lang}, a));
    this.own(this.button.select.on("change", l.hitch(this, function(a) {
    ...
    if (b && b.isLoaded && a.length && this.button) {
      ...
      if (!d) {
        ...
        (d = l.isString(c) && (c.match(/'([^']*)'/) || c.match(/"([^"]*)"/))) && (c = d[1]);
        if ("formatBlock" === a) {
          if (c && "p" != c) {
            0 > k.indexOf(this.button.values, c) && (c = "noFormat");
          } else {
            c = null;
            var e;
  ...
  k.forEach(["fontName", "fontSize", "formatBlock"], function(b) {
