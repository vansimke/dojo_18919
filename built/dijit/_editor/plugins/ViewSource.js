...
define("dijit/_editor/plugins/ViewSource", "dojo/_base/array dojo/aspect dojo/_base/declare dojo/dom-attr dojo/dom-construct dojo/dom-geometry dojo/dom-style dojo/i18n dojo/keys dojo/_base/lang dojo/on dojo/sniff dojo/window ../../focus ../_Plugin ../../form/ToggleButton ../.. ../../registry dojo/i18n!../nls/commands".split(" "), function(m, x, y, n, p, h, f, z, q, d, r, t, u, v, e, A, B, C) {
  var l = y("dijit._editor.plugins.ViewSource", e, {stripScripts:!0, stripComments:!0, stripIFrames:!0, readOnly:!1, _fsPlugin:null, toggle:function() {
    t("webkit") && (this._vsFocused = !0);
    this.button.set("checked", !this.button.get("checked"));
  }, _initButton:function() {
    var a = z.getLocalization("dijit._editor", "commands"), b = this.editor;
    this.button = new A({label:a.viewSource, ownerDocument:b.ownerDocument, dir:b.dir, lang:b.lang, showLabel:!1, iconClass:this.iconClassPrefix + " " + this.iconClassPrefix + "ViewSource", tabIndex:"-1", onChange:d.hitch(this, "_showSource")});
    this.button.set("readOnly", !1);
  }, setEditor:function(a) {
    this.editor = a;
    this._initButton();
    this.editor.addKeyHandler(q.F12, !0, !0, d.hitch(this, function(a) {
      this.button.focus();
      this.toggle();
      a.stopPropagation();
      a.preventDefault();
    ...
    var b = this.editor, w = b._plugins, c;
    this._sourceShown = a;
    var g = this;
    try {
      ...
      if (a) {
        ...
        }, this.editor.onDisplayChanged(), c = b.get("value"), c = this._filter(c), b.set("value", c), m.forEach(w, function(a) {
          !a || a instanceof l || !a.isInstanceOf(e) || a.set("disabled", !0);
        }), this._fsPlugin && (this._fsPlugin._getAltViewNode = function() {
          return g.sourceArea;
        }), this.sourceArea.value = c, this.sourceArea.style.height = b.iframe.style.height, this.sourceArea.style.width = b.iframe.style.width, b.iframe.parentNode.style.position = "relative", f.set(b.iframe, {position:"absolute", top:0, visibility:"hidden"}), f.set(this.sourceArea, {display:"block"}), this._resizeHandle = r(window, "resize", d.hitch(this, function() {
        ...
        f.set(b.iframe, {position:"relative", visibility:"visible"});
    ...
    var a = this.editor, b = a.getHeaderHeight(), d = a.getFooterHeight(), c = h.position(a.domNode), g = h.getPadBorderExtents(a.iframe.parentNode), k = h.getMarginExtents(a.iframe.parentNode), f = h.getPadBorderExtents(a.domNode), e = c.w - f.w, c = c.h - (b + f.h + d);
    this._fsPlugin && this._fsPlugin.isFullscreen && (a = u.getBox(a.ownerDocument), e = a.w - f.w, c = a.h - (b + f.h + d));
    h.setMarginBox(this.sourceArea, {w:Math.round(e - (g.w + k.w)), h:Math.round(c - (g.h + k.h))});
    ...
    t("ie") && a.iframe.parentNode.lastChild !== a.iframe && f.set(a.iframe.parentNode.lastChild, {width:"0px", height:"0px", padding:"0px", margin:"0px", borderWidth:"0px", borderStyle:"none"});
    a._viewsource_oldFocus = a.focus;
    var e = this;
    a.focus = function() {
      if (e._sourceShown) {
        e.setSourceAreaCaret();
      } else {
        try {
  ...
  e.registry.viewSource = e.registry.viewsource = function(a) {
    return new l({readOnly:"readOnly" in a ? a.readOnly : !1, stripComments:"stripComments" in a ? a.stripComments : !0, stripScripts:"stripScripts" in a ? a.stripScripts : !0, stripIFrames:"stripIFrames" in a ? a.stripIFrames : !0});
  };
  return l;
});
