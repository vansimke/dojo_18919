//>>built
define("dijit/_editor/RichText", "dojo/_base/array dojo/_base/config dojo/_base/declare dojo/_base/Deferred dojo/dom dojo/dom-attr dojo/dom-class dojo/dom-construct dojo/dom-geometry dojo/dom-style dojo/_base/kernel dojo/keys dojo/_base/lang dojo/on dojo/query dojo/domReady dojo/sniff dojo/string dojo/topic dojo/_base/unload dojo/_base/url dojo/window ../_Widget ../_CssStateMixin ../selection ./range ./html ../focus ../main".split(" "), function(q, G, L, H, A, B, I, m, M, w, x, r, k, v, C, N, d, 
D, J, O, E, F, P, Q, R, t, y, K, z) {
  var p = L("dijit._editor.RichText", [P, Q], {constructor:function(a) {
    ...
    if (p._editorCommandsLocalized) {
      this._local2NativeFormatNames = p._local2NativeFormatNames, this._native2LocalFormatNames = p._native2LocalFormatNames;
    } else {
      ...
      this._native2LocalFormatNames = p._native2LocalFormatNames;
      ...
      var e = m.create("div", {style:{position:"absolute", top:"0px", zIndex:10, opacity:.01}, innerHTML:b});
    ...
    if (k.isString(this.value)) {
      ...
      if (b.nodeName && "textarea" == b.nodeName.toLowerCase()) {
        ...
        var e = k.hitch(this, function() {
          w.set(f, {display:"block", position:"absolute", top:"-1000px"});
          if (d("ie")) {
            var a = f.style;
        ...
        c = y.getChildrenHtml(b), b.innerHTML = "";
      }
    }
    this.value = c;
    ...
    var c = "\x3cdiv id\x3d'dijitEditorBody' role\x3d'textbox' aria-multiline\x3d'true' " + (b ? " aria-label\x3d'" + D.escape(b) + "'" : "") + "\x3e\x3c/div\x3e", f = [a.fontWeight, a.fontSize, a.fontFamily].join(" "), e = a.lineHeight, e = 0 <= e.indexOf("px") ? parseFloat(e) / parseFloat(a.fontSize) : 0 <= e.indexOf("em") ? parseFloat(e) : "normal", u = "", g = this;
    this.style.replace(/(^|;)\s*(line-|font-?)[^;]+/ig, function(a) {
      a = a.replace(/^;/ig, "") + ";";
      var b = a.split(":")[0];
      if (b) {
        var b = k.trim(b), b = b.toLowerCase(), c, e = "";
    ...
    d("trident") || d("edge") ? "" : "\tli{ min-height:1.2em; }\n", "\x3c/style\x3e\n", this._applyEditingAreaStyleSheets(), "\n\x3c/head\x3e\n\x3cbody role\x3d'application'", b ? " aria-label\x3d'" + D.escape(b) + "'" : "", "onload\x3d'try{frameElement \x26\x26 frameElement._loadFunc(window,document)}catch(e){document.domain\x3d\"" + document.domain + "\";frameElement._loadFunc(window,document)}' ", "style\x3d'" + u + "'\x3e", c, "\x3c/body\x3e\n\x3c/html\x3e"].join("");
  }, _applyEditingAreaStyleSheets:function() {
    var a = [];
    this.styleSheets && (a = this.styleSheets.split(";"), this.styleSheets = "");
    a = a.concat(this.editingAreaStyleSheets);
    this.editingAreaStyleSheets = [];
    for (var b = "", c = 0, f, e = F.get(this.ownerDocument);f = a[c++];) {
      f = (new E(e.location, f)).toString(), this.editingAreaStyleSheets.push(f), b += '\x3clink rel\x3d"stylesheet" type\x3d"text/css" href\x3d"' + f + '"/\x3e';
    }
    return b;
  }, addStyleSheet:function(a) {
    var b = a.toString(), c = F.get(this.ownerDocument);
    if ("." === b.charAt(0) || "/" !== b.charAt(0) && !a.host) {
      b = (new E(c.location, b)).toString();
    }
    -1 < q.indexOf(this.editingAreaStyleSheets, b) || (this.editingAreaStyleSheets.push(b), this.onLoadDeferred.then(k.hitch(this, function() {
    ...
    -1 !== a && (delete this.editingAreaStyleSheets[a], C('link[href\x3d"' + b + '"]', this.window.document).orphan());
    ...
    if (a.keyCode === r.SHIFT || a.keyCode === r.ALT || a.keyCode === r.META || a.keyCode === r.CTRL) {
      return !0;
    }
    ...
    if (a.keyCode == r.TAB && !this.isTabIndent && !a.ctrlKey && !a.altKey) {
      return a.shiftKey ? this.beforeIframeNode.focus() : this.afterIframeNode.focus(), !0;
    }
    9 > d("ie") && a.keyCode === r.BACKSPACE && "Control" === this.document.selection.type && (a.stopPropagation(), a.preventDefault(), this.execCommand("delete"));
    ...
    if (void 0 !== b) {
      ...
      "formatblock" === a && (d("ie") || d("trident")) && (b = "\x3c" + b + "\x3e");
    }
    var f = "_" + a + "Impl";
    if (this[f]) {
      c = this[f](b);
    ...
    x.deprecated("dijit.Editor::getNodeHtml is deprecated", "use dijit/_editor/html::getNodeHtml instead", 2);
    ...
    return d("opera") ? this.window.getSelection().isCollapsed ? !0 : this.document.queryCommandEnabled("createlink") : this._browserQueryCommandEnabled("createlink");
  }, _unlinkEnabledImpl:function() {
    return d("mozilla") || d("webkit") ? this.selection.hasAncestorElement("a") : this._browserQueryCommandEnabled("unlink");
  }, _inserttableEnabledImpl:function() {
    return d("mozilla") || d("webkit") ? !0 : this._browserQueryCommandEnabled("inserttable");
    ...
    return d("webkit") ? !0 : this._browserQueryCommandEnabled("paste");
    ...
    if (9 > d("ie")) {
      ...
      if (8 > d("trident")) {
        ...
        if (e && e.rangeCount && e.getRangeAt) {
          ...
          var u = m.create("div");
          u.innerHTML = a;
          for (var g, f = this.document.createDocumentFragment();a = u.firstChild;) {
            g = f.appendChild(a);
          }
          c.insertNode(f);
    ...
    if (a && a.childNodes) {
      ...
      for (c = 0;c < a.childNodes.length;c++) {
        var f = M.position(a.childNodes[c]), b = b + f.h
      }
    }
    return b;
    ...
    if (this.isLoaded) {
      return C(".ieFormatBreakerSpan", a).forEach(function(a) {
        for (;a.firstChild;) {
