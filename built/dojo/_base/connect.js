//>>built
define("dojo/_base/connect", "./kernel ../on ../topic ../aspect ./event ../mouse ./sniff ./lang ../keys".split(" "), function(m, g, n, v, z, r, h, l) {
  function w(a, c, b, e, t) {
    e = l.hitch(b, e);
    if (!a || !a.addEventListener && !a.attachEvent) {
      return v.after(a || m.global, c, e, !0);
    }
  ...
  var x = {106:42, 111:47, 186:59, 187:43, 188:44, 189:45, 190:46, 191:47, 192:96, 219:91, 220:92, 221:93, 222:39, 229:113}, y = h("mac") ? "metaKey" : "ctrlKey", q = function(a, c) {
    var b = l.mixin({}, a, c);
    u(b);
