...
define("dojo/_base/fx", "./kernel ./config ./lang ../Evented ./Color ../aspect ../sniff ../dom ../dom-style".split(" "), function(r, x, f, y, k, m, z, t, n) {
  var l = f.mixin, d = {}, u = d._Line = function(a, b) {
    this.start = a;
    this.end = b;
  };
  ...
  h.prototype = new y;
  f.extend(h, {duration:350, repeat:0, rate:20, _percent:0, _startRepeatCount:0, _getStep:function() {
    var a = this._percent, b = this.easing;
    return b ? b(a) : a;
  }, _fire:function(a, b) {
    var g = b || [];
    if (this[a]) {
      if (x.debugAtAllCosts) {
        this[a].apply(this, g);
      } else {
        try {
          this[a].apply(this, g);
    ...
    var g = a || this.delay, e = f.hitch(this, "_play", b);
    if (0 < g) {
      return this._delayTimer = setTimeout(e, g), this;
    }
    e();
    return this;
  }, _play:function(a) {
  ...
  var p = 0, q = null, v = {run:function() {
  }};
  f.extend(h, {_startTimer:function() {
  ...
  d.fadeIn = function(a) {
    return d._fade(l({end:1}, a));
  };
  d.fadeOut = function(a) {
    return d._fade(l({end:0}, a));
  };
  ...
  w.prototype.getValue = function(a) {
    ...
    for (g in this._properties) {
      var e = this._properties[g], d = e.start;
  ...
  d.anim = function(a, b, g, e, f, c) {
    return d.animateProperty({node:a, duration:g || h.prototype.duration, properties:b, easing:e, onEnd:f}).play(c || 0);
  };
  l(r, d);
  r._Animation = h;
  return d;
