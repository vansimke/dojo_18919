//>>built
define("dojo/NodeList-dom", "./_base/kernel ./query ./_base/array ./_base/lang ./dom-class ./dom-construct ./dom-geometry ./dom-attr ./dom-style".split(" "), function(k, g, w, l, n, m, p, q, x) {
  function r(a) {
  ...
  var t = function(a) {
    ...
    var b = a.parentNode;
    b && b.removeChild(a);
  }, e = g.NodeList, u = e._adaptWithCondition, f = e._adaptAsForEach, v = e._adaptAsMap;
  l.extend(e, {_normalize:function(a, b) {
    ...
    if (1 == b.nodeType || "only" != c) {
      for (var h, g = a.length, e = g - 1;0 <= e;e--) {
        ...
        if (a._runParse && k.parser && k.parser.parse) {
          for (h || (h = b.ownerDocument.createElement("div")), h.appendChild(f), k.parser.parse(h), f = h.firstChild;h.firstChild;) {
  ...
  }, position:v(p.position), attr:u(r(q), t), style:u(r(x), t), addClass:f(n.add), removeClass:f(n.remove), toggleClass:f(n.toggle), replaceClass:f(n.replace), empty:f(m.empty), removeAttr:f(q.remove), marginBox:v(p.getMarginBox), place:function(a, b) {
    var c = g(a)[0];
    return this.forEach(function(a) {
      m.place(a, c, b);
    });
  }, orphan:function(a) {
    return (a ? g._filterResult(this, a) : this).forEach(y);
  }, adopt:function(a, b) {
    ...
    return this._wrap(w.filter(c, b[d], b[d + 1]), this);
