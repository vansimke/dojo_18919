...
define("dojo/data/ObjectStore", "../_base/lang ../Evented ../_base/declare ../_base/Deferred ../_base/array ../_base/connect ../regexp".split(" "), function(h, r, t, l, q, u, v) {
  ...
  return t("dojo.data.ObjectStore", [r], {objectStore:null, constructor:function(a) {
    this._dirtyObjects = [];
    ...
    if ("object" == typeof e) {
      ...
      for (f in e) {
        var k = e[f];
        "string" == typeof k && (e[f] = RegExp("^" + v.escapeString(k, "*?\\").replace(/\\.|\*|\?/g, w) + "$", a.ignoreCase ? "mi" : "m"), e[f].toString = function(a) {
          return function() {
            return a;
          };
        }(k));
    ...
    try {
      ...
      for (var h = 0;h < f.length;h++) {
        var m = f[h], n = m.object, p = m.old;
        delete n.__isDirty;
        n ? c = this.objectStore.put(n, {overwrite:!!p}) : "undefined" != typeof p && (c = this.objectStore.remove(this.getIdentity(p)));
        d.push(m);
        f.splice(h--, 1);
        l.when(c, function(c) {
