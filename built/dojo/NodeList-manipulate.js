//>>built
define("dojo/NodeList-manipulate", "./query ./_base/lang ./_base/array ./dom-construct ./dom-attr ./NodeList-dom".split(" "), function(l, m, t, p, q) {
  function r(a) {
  ...
  m.extend(f, {_placeMultiple:function(a, b) {
    ...
    if (arguments.length) {
      for (var b = m.isArray(a), c = 0, d;d = this[c];c++) {
        ...
        if ("SELECT" == g) {
          for (g = d.options, e = 0;e < g.length;e++) {
            var h = g[e];
            h.selected = d.multiple ? -1 != t.indexOf(a, h.value) : h.value == f;
          }
        } else {
