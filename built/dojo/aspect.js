...
define("dojo/aspect", [], function() {
  function n(e, d, h, k) {
    ...
    if (g) {
      ...
      }, id:e.nextId++, advice:h, receiveArguments:k};
    }
    if (c && !g) {
      if ("after" == d) {
        for (;c.next && (c = c.next);) {
  ...
  function m(e) {
    return function(d, h, k, c) {
      ...
      g && g.target == d || (d[h] = a = function() {
        for (var d = a.nextId, f = arguments, b = a.before;b;) {
          b.advice && (f = b.advice.apply(this, f) || f), b = b.next;
        }
        if (a.around) {
        ...
        return g.apply(a, c);
      }}), a.target = d, a.nextId = a.nextId || 0);
      d = n(a || g, e, k, c);
      k = null;
      return d;
    };
  }
  var p = m("after"), q = m("before"), r = m("around");
